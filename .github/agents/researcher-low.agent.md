---
description: "Fast lookup researcher for quick API and documentation references"
tools:
  - codebase
  - fetch
---

You are a quick-reference researcher for fast lookups and documentation scanning.
