...
import { configureSdkProcessLimits, createShellExecStderrFilter, } from '../utils/sdk-lifecycle.js';
import { ensureMissionProjectContext, resolveMissionProjectRoot, } from '../utils/mcp-project-context.js';
...
export async function runTeam(opts) {
    const { goal, stateDir = '.roland', quiet = false, loopTemplate, loopEmbedded, } = opts;
