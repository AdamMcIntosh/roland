...
export function lacksNpmTestScript(cwd) {
...
export function isNoTestSpecifiedOutput(stdout, stderr) {
...
export function shouldSoftSkipMissingTests(strategyType) {
...
export function lacksLintConfig(cwd) {
    const pkgPath = path.join(cwd, 'package.json');
    try {
        const raw = fs.readFileSync(pkgPath, 'utf-8');
        const pkg = JSON.parse(raw);
 ...
 */
//# sourceMappingURL=minimal-project.js.map