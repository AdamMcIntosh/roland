...
export function generateImprovementProposals(input) {
    const proposals = [];
...
function mapStrategyCategory(type) {
    if (type === 'lint')
        return 'lint';
    if (type === 'unit' || type === 'integration' || type === 'e2e' || type === 'smoke')
        return 'test';
    if (type === 'typecheck')
        return 'implementation';
    return 'implementation';
}
//# sourceMappingURL=improvement-proposals.js.map