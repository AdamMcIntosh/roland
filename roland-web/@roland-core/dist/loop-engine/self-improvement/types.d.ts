...
export declare function normalizeCritiqueLane(lane: string): CritiqueModel;
...
export declare function critiqueOutputToSnapshot(output: CritiqueOutput): LoopCritiqueSnapshot;
