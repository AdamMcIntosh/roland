 ...
 */
export function runGitCommitAction(opts) {
    ...
    try {
        ...
        if (!opts.autoStage && (!files || files.length === 0)) {
            ...
            return {
                ...
                message,
                stdout: short,
                stderr: 'git-commit: dry_run is false but auto_stage is false and include_files is empty — enable auto_stage or set include_files',
                exitCode: 1,
            };
        }
...
//# sourceMappingURL=git-commit-action.js.map