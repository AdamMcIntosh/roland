 ...
 */
function conditionId(c, index) {
    return c.id ?? `${c.type}-${index}`;
}
function evaluateOne(condition, index, ctx) {
 ...
 */
export function evaluateExitConditions(conditions, ctx) {
    const rules = conditions && conditions.length > 0
        ? conditions
        : [{ type: 'all_gates_pass', description: 'All gates pass (default)' }];
 ...
 */
//# sourceMappingURL=exit-conditions.js.map