...
import { resolveMcpProjectContext, withProjectContext, } from '../utils/mcp-project-context.js';
...
import { createRegistrar, registerAllTools, resolveRecipesDir, } from './tools/index.js';
// ============================================================================
...
export function buildGeneralMcpHttpEntry(baseUrl = 'http://127.0.0.1:8081/mcp', options) {
...
export class McpServer {
    ...
    constructor(config, options = {}) {
        ...
        this.server = new Server({ name: 'roland', version: readPackageVersion(import.meta.url) }, { capabilities: { tools: {} } });
        this.setupHandlers();
    }
    buildToolContext() {
        return {
    ...
    getTools() { return Array.from(this.tools.keys()); }
