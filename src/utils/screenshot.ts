...
export async function analyzeScreenshot(
  opts: ScreenshotAnalysisOptions = {}
): Promise<ScreenshotAnalysisResult> {
  const {
    filePath,
    prompt = 'Describe what you see in this image in detail. Focus on any code, error messages, UI elements, or anything relevant to software development.',
