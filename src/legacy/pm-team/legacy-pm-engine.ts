...
import { CommandBlackboard } from '../../rco/command-blackboard.js';
import type { Callsign } from '../../rco/command-blackboard.js';
import { MessageBus } from '../../rco/message-bus.js';
import {
  ...
  isReviewDecision,
} from '../../rco/pm-prompts.js';
import type { ReviewDecision, WaveResult } from '../../rco/pm-prompts.js';
...
} from '../../rco/constants.js';
import { ProjectMemory } from '../../rco/project-memory.js';
import {
  ...
  type HumanFeedback,
} from '../../rco/self-improvement.js';
import { loadProjectKnowledge, appendDecisions } from '../../rco/project-knowledge.js';
import { buildTaskUsage, buildRunUsage, saveRunUsage } from '../../rco/usage-tracker.js';
import type { TaskUsageRecord } from '../../rco/usage-tracker.js';
...
} from '../../rco/unsc-agents.js';
import { finalizeSynthesisOutput } from '../../rco/mission-complete.js';
import {
  TaskGitWorkflow,
  isExecutorAgent,
  type TaskGitInfo,
} from '../../rco/task-git-workflow.js';
...
export async function runLegacyPmTeam(opts: TeamOrchestratorOptions): Promise<TeamResult> {
  const {
 ...
 *
 * Legacy PM wave/DAG engine isolated from team-orchestrator.ts thin router.
 * Removal target: v1.6.0 — opt-in via `--legacy-pm` only.
 */
